...
{
    public static WebViewHandler Instance = null;
    ...
    private void Update()
    {
        //TODO : Open a Dialogue to ask Abort Payment (YES OR NO) then Close
    ...
    private IEnumerator InitWebView(string webViewUrl)
    {
